...
describe('DiscriminatorTypeComposer', () => {
  ...
  describe('class methods', () => {
    let characterDTC: DiscriminatorTypeComposer<any, any>;
    let personTC: ObjectTypeComposer;
    let droidTC: ObjectTypeComposer;
    ...
    describe('setFields(fields)', () => {
      let personSpecificFields: string[];
      let droidSpecificFields: string[];
      let fieldsToSet: Record<string, string>;
    ...
    describe('addRelation(fieldName, relationOpts)', () => {
      ...
      it('should create relation on baseTC', () => {
        expect((characterDTC.getRelations()[relationField] as any).resolver).toEqual(
          relationResolver
        );
      });
      ...
      it('should create Movie relation on childTC', () => {
        expect((personTC.getRelations()[relationField] as any).resolver).toEqual(relationResolver);
        expect((droidTC.getRelations()[relationField] as any).resolver).toEqual(relationResolver);
      });
    });
  });
  ...
  describe('discriminator()', () => {
    ...
    it('should pass down baseTypeComposerResolverOptions', () => {
      ...
      expect(createOneRecordArgTC.isFieldNonNull('dob')).toBe(true);
