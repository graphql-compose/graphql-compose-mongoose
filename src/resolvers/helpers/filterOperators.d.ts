...
type PlainOperatorFieldTypeMap<FieldType> = Record<PlainOperatorNames, FieldType>;
type ArrayOperatorFieldTypeMap<FieldType> = Record<ArrayOperatorNames, FieldType[]>;

// IndexedFieldsMap = { fieldName: type }
export type Filter_operatorsArgs<IndexedFieldMap> = {
  [fieldName in keyof IndexedFieldMap]: PlainOperatorFieldTypeMap<IndexedFieldMap[fieldName]> &
...
export function processFilterOperators(filter: object): Record<string, any>;
